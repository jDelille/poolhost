     ...
     <div className="ht-odds">
         <div className='team-odds'>
            ...
            <div className="name-logo">
               <img className="team-logo-picks" src={`../icons/${item.competitors[0].abbreviation}.svg`} alt='logo' />
               {/* team name */}
               <h1 className="odds-name">{item.odds.homeTeamOdds?.team?.abbreviation}</h1>
            </div>
   ...
   {/* road team */}
    <div className="rt-odds">
         <div className='team-odds'>
            {/* team logo */}
            <div className="name-logo">
               <img className="team-logo-picks" src={`../icons/${item.competitors[1].abbreviation}.svg`} alt='logo' />
               {/* team name  */}
               <h1 className="odds-name">{item.odds.awayTeamOdds?.team?.abbreviation}</h1>
            </div>
            {/* favorite or underdog */}
            <div className="fav-underdog">
