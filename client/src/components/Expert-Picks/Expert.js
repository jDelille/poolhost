          ...
          return(
            <>
              <div className="display-games-week">
                <h4 className={item?.homeScore > item?.awayScore ? 'winner' : item?.homeScore < item?.awayScore ? 'loser' : 'home-label'}> {item?.homeTeam} </h4>
                <p className='at-symbol'> @ </p>
                <h4 className={item?.awayScore > item?.homeScore ? 'winner' : item?.awayScore < item?.homeScore ? 'loser' : 'away-label'}> {item?.awayTeam} </h4>
              </div>
            </>
          )
        })}
      ...
      <div className="user-bar">
        ...
        <div className='no-picks-list'>
         ...
         {signedInPicks?.picks?.map((item, index) => {
           if(index !== 0 ){
            return (
              <div className={item === 'missed' ? 'hide' : "show-user-pick"}>
          ...
          <div className="expert-bar">
            <div className="expert-info">
              ...
              {item.displayName ? (
                ...
                <h1 className="affiliation email-display">{item.email}</h1>
              )}
            ...
            {item.picks?.map((item, index) => {
              if(index !== 0) {
                ...
                return (
                  <div className={item === item?.isInteger ? 'hide' : "show-user-pick"}>
